...
void xmrig::JobResults::submit(const Job& job, uint32_t nonce, const uint8_t* result, const uint8_t* power_signature)
{
    submit(JobResult(job, nonce, result, nullptr, nullptr, power_signature));
}
