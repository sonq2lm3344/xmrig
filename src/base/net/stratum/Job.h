...
#   ifdef XMRIG_PROXY_PROJECT
    ...
    void setMinerTx(const uint8_t* begin, const uint8_t* end, size_t powerTxEphPubKeyOffset, size_t powerTxPubKeyOffset, size_t powerTxExtraNonceOffset, size_t powerTxExtraNonceSize, const Buffer& powerTxMerkleTreeBranch, bool hasViewTag);
